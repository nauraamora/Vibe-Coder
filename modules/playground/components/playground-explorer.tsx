      ...
      <SidebarMenuItem>
        <div className="flex items-center group">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <span
                className="inline-flex items-center justify-center h-6 w-6 opacity-0 group-hover:opacity-100 transition-opacity hover:bg-accent hover:text-accent-foreground rounded-md cursor-pointer"
              >
